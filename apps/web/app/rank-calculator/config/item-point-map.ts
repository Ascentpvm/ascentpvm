...
export const itemPointOverrides: Partial<Record<CollectionLogItemName, number>> = {
  ...
  "Pet dagannoth prime": 0,
  "Pet dagannoth rex": 0,
  Yami: 0,
  "Pet dagannoth supreme": 0,
  "Pet dark core": 0,
  "Pet general graardor": 0,
  "Pet k'ril tsutsaroth": 0,
  "Pet kraken": 0,
  "Pet kree'arra": 0,
  "Pet penance queen": 0,
  "Pet smoke devil": 0,
